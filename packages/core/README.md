...
Theatre.js comes in two packages: `@framewright/core` (the library) and `@framewright/studio` (the editor). This package is the core library.

## Bundle size

`@framewright/core` is currently around 20KiB compressed with all its dependencies.
