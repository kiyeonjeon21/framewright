...
```sh
$ npm install @framewright/dataverse
# and the react bindings
$ npm install @framewright/react
```
...
```tsx
import {useAtom} form '@framewright/react'
...
```tsx
import {useVal, useAtom} from '@framewright/react'
...
```ts
import {Ticker, onChange} from '@framewright/dataverse'
...
- Also see [`@framewright/react`](../react/README.md) to learn more about the React
  bindings.
