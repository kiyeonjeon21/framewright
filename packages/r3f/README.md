...
**Here be dragons! 🐉** `@framewright/r3f` is pre-release software, the API, the internal logic, and even the package name can and will drastically change at any time, without warning.
...
# Theatre.js
yarn add @framewright/core
yarn add @framewright/studio

yarn add @framewright/r3f
```

```tsx
import React from 'react';
import { Canvas } from 'react-three-fiber';
import {editable as e, SheetProvider, extension} from '@framewright/r3f';
import studio from '@framewright/studio';
...
```ts
import { editable } from '@framewright/r3f';
