import type {SequenceEditorTree_AllRowTypes} from '@framewright/studio/panels/SequenceEditorPanel/layout/tree'
import type {PropAddress} from '@framewright/core/types/public'
