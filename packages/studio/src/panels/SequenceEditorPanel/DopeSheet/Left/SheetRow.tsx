import type {SequenceEditorTree_Sheet} from '@framewright/studio/panels/SequenceEditorPanel/layout/tree'
import {usePrism} from '@framewright/react'
import React from 'react'
import LeftSheetObjectRow from './SheetObjectRow'
import AnyCompositeRow from './AnyCompositeRow'
import {setCollapsedSheetItem} from '@framewright/studio/panels/SequenceEditorPanel/DopeSheet/setCollapsedSheetObjectOrCompoundProp'
import uniqueKeyForAnyObject from '@framewright/utils/uniqueKeyForAnyObject'
